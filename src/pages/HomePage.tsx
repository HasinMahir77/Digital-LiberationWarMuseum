        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-white mb-2">{t('homePage.quickStats.digitalArtifactsCount', { count: new Intl.NumberFormat(i18n.language).format(artifacts.length) })}</h3>
