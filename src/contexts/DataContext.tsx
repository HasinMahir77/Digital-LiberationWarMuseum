...
const mockArtifacts: Artifact[] = [
  {
    ...
    contributorName: 'Bangladeshi Citizen',
    objectType: 'Photograph',
    objectHead: 'Victory Day Celebration Photo',
    description: 'A photograph capturing the joyous celebration of Victory Day in Dhaka after the Liberation War.',
  ...
  },
  {
    ...
    objectType: 'Document',
    objectHead: 'Declaration of Independence Document',
    description: 'A replica of the historic document declaring Bangladesh\'s independence.',
    measurement: '11 x 8.5 inches',
    images: ['https://www.dhakalawreview.org/wp-content/uploads/2015/04/1.jpg'],
    galleryNumber: 'G-02',
    foundPlace: 'Mujibnagar, Bangladesh',
  ...
  },
  {
    ...
    contributorName: 'Freedom Fighter Squad 7',
    objectType: 'Weapon',
    objectHead: '7.62 MM Rifle (G3P3)',
    description: 'A 7.62 MM rifle, commonly used by Mukti Bahini freedom fighters during the Liberation War.',
  ...
  },
  {
    ...
    contributorName: 'Mukti Bahini Quartermaster',
    objectType: 'Weapon',
    objectHead: 'Sten Gun Mk II',
    description: 'A Sten Gun Mk II, a simple yet effective submachine gun widely used by freedom fighters during the 1971 Liberation War.',
  ...
  },
  {
    ...
    contributorName: 'International Arms Aid',
    objectType: 'Weapon',
    objectHead: 'AK-47 Assault Rifle',
    description: 'An AK-47 assault rifle, a symbol of international support and the fierce combat during the Liberation War.',
    ...
    galleryNumber: 'G-05',
    foundPlace: 'Border Region, Bangladesh',
